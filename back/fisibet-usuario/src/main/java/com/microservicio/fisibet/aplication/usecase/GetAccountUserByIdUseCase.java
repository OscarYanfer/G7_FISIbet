...
public class GetAccountUserByIdUseCase {
    private AccountUserPort accountUserPort;
    private AccountUserMapper accountUserMapper;
    private ConnectionPort connectionPort;
    public GetAccountUserByIdUseCase(AccountUserMapper accountUserMapper,
    ...
    public AccountUserDto run(Integer id) throws GenericException {
        try{
            this.connectionPort.begin();
            AccountUserDto accountUserDto = getAccountUserById(id);
    ...
    public AccountUserDto getAccountUserById(Integer id){
        return this.accountUserMapper.convertAccountUserEntityToAccountUserDto(this.accountUserPort.getAccountUserById(id));
    };
}
