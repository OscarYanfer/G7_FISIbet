...
public class CreateAccountUserUseCase {
    ...
    public AccountUserDto run(CreateAccountUserDto request) throws GenericException {
        try{
    ...
    public AccountUserDto createAccountUser(CreateAccountUserDto request){
        AccountUserEventEntity accountUserEventEntity = this.accountUserMapper.convertCreateAccountUserToAccountUserEventEntity(request);
        AccountUserEntity accountUserEntityNew = this.accountUserPort.createAccountUser(accountUserEventEntity);
        return this.accountUserMapper.convertAccountUserEntityToAccountUserDto(accountUserEntityNew);
    };
}
