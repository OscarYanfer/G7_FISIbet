...
public interface SessionUserMapper {
    ...
    SessionUserDto convertSessionUserEntityToSessionUserDto(SessionUserEntity sessionUserEntity);

    SessionUserResponse convertSessionUserDtoToSessionUserResponse(SessionUserDto sessionUserDto);
