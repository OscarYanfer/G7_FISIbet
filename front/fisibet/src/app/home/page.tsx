                ...
                <div className={styles.eventCard}>
                    ...
                    <div className={styles.eventBets}>
                        <button className={styles.buttonBet}>
                            <span>Perú <br /> <strong>10.00</strong></span>
                        </button>
                        <button className={styles.buttonBet}>
                            <span>Empate <br /> <strong>10.00</strong></span>
                        </button>
                        <button className={styles.buttonBet}>
                            <span>Argentina <br /> <strong>10.00</strong></span>
                        </button>
                    </div>
                </div>
            );
        ...
        <div className={styles.homeContainer}>
            ...
            <div className={styles.ticketContainer}>
                ...
                <div className={styles.buttonTicketContainer}>
                    ...
                    <button className={styles.buttonTicket}>Apuesta ahora S/ 10.00</button>
                </div>
            </div>
        </div>
    );
